...
ACGameMode::ACGameMode()
{
	...
	ConstructorHelpers::FClassFinder<ACPlayerController> controller(L"/Script/Engine.Blueprint'/Game/Blueprints/Player/BP_CPlayerController.BP_CPlayerController_C'");
